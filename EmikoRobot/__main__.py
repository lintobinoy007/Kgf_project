...
buttons = [
    [
        InlineKeyboardButton(text="About KGF Robot", callback_data="emiko_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text=" 👨‍🔧 Add KGF To Your Group 👩‍🔧 ",
            url="t.me/Kgfofficialbot?startgroup=new",
        ),
        InlineKeyboardButton(
            text=" 🕺 Add KGF VIBER To Your Group 💃 ",
            url="t.me/Tridentgroupsbot?startgroup=new",
        ),
    ],
]
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'*KGF Bot*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_kgf bot licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for Kgf bot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, KGF BOT now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            text="*๏ KGF BOT SUPPORT*"
            "\nJoin My Support Group/Channel for see or report a problem on KGF BOT.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
